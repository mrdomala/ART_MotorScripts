...
public class Update_Mobile_Email_SD {
	...
	public void Click_on_My_Profile() throws Exception {
		log.info("<---------------------------------Update Mobile No. and Email Id-------------------------------->");
...
//		stepData.getUm().ClickonContactInforamtion();
		stepData.getCm().genericJSE(stepData.getDriver(), stepData.getUm().ContactInforamtion);
...
//		stepData.getUm().ClickonUpdateMobileNo();
		stepData.getCm().genericJSE(stepData.getDriver(), stepData.getUm().Update_Mobile);
	...
	public void Click_inside_text_box() throws InterruptedException {
		Thread.sleep(4000);
		stepData.getCm().genericClear(stepData.getUm().Clear);
	...
	public void user_enter_updated_mobile_number_as_something(String mobilenumber) throws Throwable {
		Thread.sleep(3000);
		stepData.getCm().genericSendKeys(stepData.getUm().Upadated_Number, mobilenumber);
		Thread.sleep(3000);
